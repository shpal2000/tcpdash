...
void TDSessionInit(struct TDSessionState* tdSessionState);

void TDSetSessionState1(struct TDSessionState* tdSessionState, uint64_t state);

void TDSetSessionState2(struct TDSessionState* tdSessionState, uint64_t state);

void TDSetSessionLastErr(struct TDSessionState* tdSessionState, uint16_t err);

uint16_t TDGetSessionLastErr(struct TDSessionState* tdSessionState);

uint16_t TDGetSessionLastErrCount(struct TDSessionState* tdSessionState);
#endif 
